...
namespace Soti.MCDP.Metadata
{
    ...
    public class DatabaseSection : ICloneable
    {
        ...
        public static string Load()
        {
            ...
            {
                Logger.Logger.Log(Classifier.ReadError, Priority.Critical, "DatabaseSection-Load DB Error: " + ex);
                return "";
            }
        }
        ...
        private static string LoadConnectionString(string path)
        {
            ...
            try
            {
                ...
                Logger.Logger.Log(Classifier.ReadError, Priority.Critical, "DatabaseSection-Database section does not have an associated file!");
                return "";
            }
            catch (Exception ex)
            {
                Logger.Logger.Log(Classifier.ReadError, Priority.Critical, "DatabaseSection-LoadConnectionString Error!" + ex);
                return "";
            }
        }
        ...
        {            
            try
            {
                ...
                if (!config.HasFile)
                    Logger.Logger.Log(Classifier.ReadError, Priority.Critical, "DatabaseSection.GetConfiguration - Deployment Server and Management Service do not have config files!" );
                return config;
            }
            catch (Exception ex)
            {
                Logger.Logger.Log(Classifier.ReadError, Priority.Critical, "DatabaseSection-Get DB Configuration Error!" + ex);
            }
            return null;
        }     
        /// <summary>
