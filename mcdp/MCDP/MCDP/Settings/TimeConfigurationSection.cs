...
namespace Soti.MCDP.Settings
{
    ...
    internal sealed class TimeoutConfigurationSection : ConfigurationSection
    {
        ...
        /// </summary>
        public static TimeoutConfigurationSection Instance => _instance ??
        ...
        public DatabaseElement Database => (DatabaseElement) this["database"];

        /// <summary>
        /// Gets the services section
        /// </summary>
        [ConfigurationProperty("services", IsRequired = false)]
        public ServicesElement Services => (ServicesElement)this["services"];
        ...
        internal sealed class DatabaseElement : ConfigurationElement
        {
            ...
            {
                get => (int) this["longOperationTimeout"];
            ...
            {
                get => (int) this["maintenanceOperationTimeout"];
            ...
            {
                get => (int) this["waitDatabaseTimeout"];
