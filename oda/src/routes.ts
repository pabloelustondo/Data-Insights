...
import { VehicleLocations } from './controllers/vehicles/ttcVehicleLocations';
...
const models: any = {
    ...
    'VehicleData': {
        'vehicle': { typeName: 'array', required: true, arrayType: 'string' },
    },
    'VehicleInfo': {
        'metadata': { typeName: 'array', required: true, arrayType: 'string' },
        'createdAt': { typeName: 'datetime', required: true },
        'data': { typeName: 'VehicleData', required: false },
    },
};
...
export function RegisterRoutes(app: any) {
    ...
    app.get('/Vehicles/Data/GetLocations', function(req: any, res: any, next: any) {
        const params = {
        };
        ...
        const controller = new VehicleLocations();
        promiseHandler(controller.Get.apply(controller, validatedParams), res, next);
    });
