...
const models: any = {
    ...
    'Parameter': {
        'parameterName': { typeName: 'string', required: true },
        'parameterValue': { typeName: 'string', required: true },
    },
    'ReasonModel': {
        'metricName': { typeName: 'Metrics', required: true },
        'predicates': { typeName: 'array', required: true, arrayType: 'Predicates' },
        'parameters': { typeName: 'array', required: true, arrayType: 'Parameter' },
    },
};
...
export function RegisterRoutes(app: any) {
    ...
    app.post('/Devices/Battery/getMetrics', function(req: any, res: any, next: any) {
        const params = {
            'request': { typeName: 'ReasonModel', required: true },
        };
