...
export class SmlDataSet extends SmlElement{
  ...
  minHistory?: number; //how many historical/time window records I need to calculate a row of output
  windowHistory?: number; //how many historical/time window records I need to calculate a row of output
