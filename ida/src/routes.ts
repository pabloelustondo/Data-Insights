...
import { UploadLargeDataSetController } from './controllers/uploadLargeDataSet';
...
app.post('/Data/LargeDataSets',function(req: any,res: any,next: any) {
const params={
'express': { typeName: 'object',required: true,injected: 'request' },
};
...
const controller=new UploadLargeDataSetController();
promiseHandler(controller.Create.apply(controller,validatedParams),res,next);
});
